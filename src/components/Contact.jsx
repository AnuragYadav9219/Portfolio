    ...
    <section id="contact" className="py-20 px-6 bg-blue-100">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-700 text-lg mb-10">
          I'm open to collaborations, freelance opportunities, or just a friendly chat. Fill out the form or drop me an email!
        </p>
      </div>
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        <div className="mt-10 text-center text-gray-600">
          <p>
            Or email me at:{" "}
            <a href="mailto:anuragyad1398@gmail.com" className="text-blue-600 hover:underline">
